...
const HQ_NOTIFS = [
  { id: 1, iconEl: <MessageSquare size={14} />, iconBg: "#dce5f0", iconColor: "#003366", title: "สาขาส่งลีดใหม่", body: "Master House — บจ. สมุทรโกดัง ต้องการโกดัง 1,200 ตร.ม.", time: "3 นาทีที่แล้ว", href: "/hq/lead-pool" },
  { id: 2, iconEl: <ClipboardList size={14} />, iconBg: "#dce5f0", iconColor: "#003366", title: "รออนุมัติใบเสนอราคา", body: "Q-2026-0097 จากสาขา VCS Asia รอการอนุมัติ", time: "1 ชั่วโมงที่แล้ว", href: "/hq/approvals" },
  { id: 3, iconEl: <AlertTriangle size={14} />, iconBg: "#fef3cd", iconColor: "#d97706", title: "โครงการใกล้ deadline", body: "EASYBUILD แม่สอด — เหลือ 7 วัน", time: "ผ่านมา 2 ชั่วโมง", href: "/hq/projects" },
  { id: 4, iconEl: <CheckCircle2 size={14} />, iconBg: "#d1fae5", iconColor: "#059669", title: "ส่งมอบโครงการสำเร็จ", body: "โครงการระยอง VCS Asia ส่งมอบครบถ้วนแล้ว", time: "เมื่อวาน", href: "/hq/projects" },
  { id: 5, iconEl: <Banknote size={14} />, iconBg: "#d1fae5", iconColor: "#059669", title: "สรุปยอดรับชำระรวม", body: "4 สาขา รอบ มิ.ย. 69 — ฿24.6M", time: "เมื่อวาน", href: "/hq/finance" },
];

const DEALER_NOTIFS = [
  { id: 1, iconEl: <MessageSquare size={14} />, iconBg: "#dce5f0", iconColor: "#003366", title: "ลีดใหม่เข้ามา", body: "บจ. สมุทรโกดัง — ต้องการโกดัง 1,200 ตร.ม.", time: "3 นาทีที่แล้ว", href: "/leads/4" },
  { id: 2, iconEl: <CheckCircle2 size={14} />, iconBg: "#d1fae5", iconColor: "#059669", title: "อนุมัติใบเสนอราคา", body: "Q-2026-0097 ได้รับการอนุมัติจาก HQ", time: "1 ชั่วโมงที่แล้ว", href: "/quotations" },
  { id: 3, iconEl: <AlertTriangle size={14} />, iconBg: "#fef3cd", iconColor: "#d97706", title: "โครงการใกล้ deadline", body: "EASYBUILD แม่สอด — เหลือ 7 วัน", time: "ผ่านมา 2 ชั่วโมง", href: "/projects/6" },
  { id: 4, iconEl: <ClipboardList size={14} />, iconBg: "#dce5f0", iconColor: "#003366", title: "งานใหม่ถูกมอบหมาย", body: "เตรียมเอกสารส่งมอบงานโครงสร้างเหล็ก", time: "เมื่อวาน", href: "/tasks" },
  { id: 5, iconEl: <Banknote size={14} />, iconBg: "#d1fae5", iconColor: "#059669", title: "รับชำระเงินสำเร็จ", body: "โครงการระยอง VCS Asia — ฿6.2M", time: "เมื่อวาน", href: "/payments" },
];
    ...
    <>
      ...
      <header style={{ display:"flex", alignItems:"center", justifyContent:"flex-end", gap:10, padding:"10px 24px", flexShrink:0 }}>
        ...
        <button
          ...
          style={{ display:"flex", alignItems:"center", justifyContent:"center", width:40, height:40, borderRadius:"50%", background:"#fff", border:`1px solid ${BORDER}`, color:"#6b7280", boxShadow:"0 2px 14px rgba(0,0,0,.07)", cursor:"pointer", flexShrink:0 }}
        ...
        <div ref={notifsRef} style={{ position:"relative" }}>
          <button
            ...
            style={{ position:"relative", display:"flex", alignItems:"center", justifyContent:"center", width:40, height:40, borderRadius:"50%", background:"#fff", border:`1px solid ${BORDER}`, color:"#6b7280", boxShadow:"0 2px 14px rgba(0,0,0,.07)", cursor:"pointer", flexShrink:0 }}
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = "#f0f4f8"; (e.currentTarget as HTMLElement).style.color = PRIMARY; }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "#fff"; (e.currentTarget as HTMLElement).style.color = "#6b7280"; }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            ...
            {unreadCount > 0 && (
              <span style={{ position:"absolute", top:-3, right:-3, minWidth:18, height:18, background:"#dc2626", borderRadius:"50%", border:"2px solid #fafafa",
        ...
        <div ref={userRef} style={{ position:"relative" }}>
          <button
            ...
            style={{ display:"flex", alignItems:"center", gap:10, background:"#fff", border:`1px solid ${BORDER}`, borderRadius:12,
              padding:"5px 14px 5px 6px", boxShadow:"0 2px 14px rgba(0,0,0,.07)", cursor:"pointer" }}
