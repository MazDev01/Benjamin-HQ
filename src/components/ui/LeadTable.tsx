...
export function LeadTable() {
  ...
  return (
    <div style={{
      ...
      {/* Toolbar */}
      <div className="flex items-center justify-between" style={{ padding: "14px 18px", borderBottom: "1px solid #e5e7eb" }}>
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2" style={{
            background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10,
            padding: "7px 12px", minWidth: 200, boxShadow: "0 2px 14px rgba(0,0,0,.07)",
          }}>
          ...
          <button style={{
            ...
            boxShadow: "0 2px 14px rgba(0,0,0,.07)", cursor: "pointer",
          }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <button style={{
            ...
            boxShadow: "0 4px 10px rgba(0,0,0,.25)", cursor: "pointer",
          }}>
            + เพิ่มลีด
          </button>
        </div>
      ...
      {/* Pagination */}
      <div className="flex items-center justify-between" style={{ padding: "12px 16px", borderTop: "1px solid #e5e7eb" }}>
