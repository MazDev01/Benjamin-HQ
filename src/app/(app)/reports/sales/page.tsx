      ...
      {data.map((d, i) => {
        ...
        return (
          <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, flex: 1 }}>
            ...
            <div style={{ width: "100%", background: isLatest ? "#003366" : "#e5e7eb", borderRadius: "4px 4px 0 0", height: `${pct * BAR_H}px`, transition: "height .3s" }} />
  ...
  return (
    <div>
      <div style={{ marginBottom: 16 }}>
        <h1 style={{ fontSize: "1.55rem", fontWeight: 800, color: "#2D2D2D", marginBottom: 3 }}>รายงานยอดขาย</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 16 }}>
        {[
          ...
          <div key={i} style={{ ...CARD, padding: "14px 16px" }}>
            ...
            <div style={{ fontSize: "0.7rem", fontWeight: 600, color: s.up ? "#059669" : "#dc2626", marginTop: 4 }}>{s.delta}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr", gap: 14, marginBottom: 14 }}>
        ...
        <div style={{ ...CARD, padding: "16px" }}>
          ...
          {[
            ...
            { label: "ยกเลิก", count: leads.filter(l => l.status === "CANCELLED").length, color: "#dc2626", bg: "#fee2e2" },
            { label: "ออกใบเสนอราคา", count: leads.filter(l => l.status === "QUOTED").length, color: "#003366", bg: "#dce5f0" },
              ...
              {[...leads].sort((a, b) => {
                ...
                <tr key={l.id} style={{ borderBottom: "1px solid #f0f4f8" }}
                  ...
                  <td style={{ padding: "11px 14px" }}>
                    <span style={{ padding: "3px 10px", borderRadius: 99, fontSize: "0.68rem", fontWeight: 700, background: l.status === "PAID" ? "#e5faf0" : l.status === "CANCELLED" ? "#fee2e2" : "#dce5f0", color: l.status === "PAID" ? "#059669" : l.status === "CANCELLED" ? "#dc2626" : "#003366" }}>
