  ...
  return (
    <div>
      <div style={{ marginBottom: 16 }}>
        <h1 style={{ fontSize: "1.55rem", fontWeight: 800, color: "#2D2D2D", marginBottom: 3 }}>วิเคราะห์ข้อมูล</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 16 }}>
        {[
          ...
          <div key={i} style={{ ...CARD, padding: "14px 16px" }}>
            ...
            <div style={{ fontSize: "0.7rem", fontWeight: 700, color: s.up ? "#059669" : "#dc2626", marginTop: 4 }}>{s.delta} vs เดือนที่แล้ว</div>
          </div>
        ))}
      </div>
