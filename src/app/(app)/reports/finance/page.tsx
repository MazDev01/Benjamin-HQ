      ...
      {data.map((d, i) => (
        <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2, flex: 1 }}>
          <div style={{ display: "flex", alignItems: "flex-end", gap: 2, width: "100%" }}>
            ...
            <div style={{ flex: 1, background: "#dc2626", borderRadius: "3px 3px 0 0", height: `${(d.expense / max) * BAR_H}px` }} />
          </div>
  ...
  return (
    <div>
      <div style={{ marginBottom: 16 }}>
        <h1 style={{ fontSize: "1.55rem", fontWeight: 800, color: "#2D2D2D", marginBottom: 3 }}>รายงานการเงิน</h1>
        ...
        <div style={{ ...CARD, padding: "16px 16px 10px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 4, fontSize: "0.68rem", color: "#dc2626" }}>
                <span style={{ width: 10, height: 10, borderRadius: 3, background: "#dc2626", display: "inline-block" }} /> รายจ่าย
              </span>
            </div>
          </div>
              ...
              {[
                ...
                <tr key={i} style={{ borderBottom: "1px solid #f0f4f8" }}
                  ...
                  <td style={{ padding: "11px 14px" }}>
                    <span style={{ padding: "3px 10px", borderRadius: 99, fontSize: "0.68rem", fontWeight: 700, background: r.pos ? "#e5faf0" : "#fee2e2", color: r.pos ? "#059669" : "#dc2626" }}>{r.type}</span>
                  </td>
                  <td style={{ padding: "11px 14px", fontSize: "0.9rem", fontWeight: 800, color: r.pos ? "#059669" : "#dc2626" }}>
                    {r.pos ? "+" : "-"}{r.amount}
                  </td>
                </tr>
              ))}
