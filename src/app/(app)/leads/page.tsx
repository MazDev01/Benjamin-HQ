...
const TAG_COLORS: Record<string,string> = {
  ...
  "โครงการใหญ่":"#003366","รอ BOQ":"#6b7280","ส่งใบเสนอแล้ว":"#003366",
};
...
export default function LeadsPage() {
  ...
  const thStyle = (key: SortKey): React.CSSProperties => ({ ...thBase, cursor:"pointer", userSelect:"none" });
    ...
    <>
      ...
      <div>
        ...
        <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:16 }}>
          <div>
            <h1 style={{ fontSize:"1.55rem", fontWeight:800, color:"#2D2D2D", marginBottom:3 }}>ผู้สนใจ</h1>
                ...
                <thead>
                  <tr style={{ borderBottom:"1px solid #e5e7eb", background:"#f8f9fb" }}>
                    {([
                      ...
                      <th key={label} style={key ? thStyle(key) : thBase}
                      ...
                      <tr key={l.id} onClick={()=>openPanel(l)}
                        ...
                        <td style={{ padding:"11px 14px", position:"relative" }}
                          ...
                          <button style={{ display:"inline-flex", alignItems:"center", gap:4, padding:"3px 10px", borderRadius:99,
                            fontSize:"0.68rem", fontWeight:700, background:sc.bg, color:sc.text, border:"none", cursor:"pointer", whiteSpace:"nowrap" }}>
          ...
          <div style={{ position:"fixed", top:editPopupPos.top, left:editPopupPos.left,
            ...
            <div style={{ display:"flex", justifyContent:"flex-end" }}>
              <button onClick={commitFieldPopup}
                style={{ padding:"8px 20px", borderRadius:9, background:"#dc2626",
            ...
            <div onClick={e=>e.stopPropagation()}
              ...
              <div style={{ display:"flex", alignItems:"center", borderBottom:"1px solid #e5e7eb",
                ...
                <button onClick={closePanel}
                  style={{ width:32, height:32, borderRadius:9, border:"1px solid #e5e7eb",
